...
public class QLog {
    ...
    public static class PATH {
        ...
        public static String getAppCacheLogPath(Context context) {
            return getAppCachePath(context) + "/log.txt";
        }
    }
    ...
    public QLog(Context context) {
        this(PATH.getAppCacheLogPath(context));
