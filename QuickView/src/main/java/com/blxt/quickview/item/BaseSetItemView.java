...
public class BaseSetItemView
    ...
    public BaseSetItemView(Context context, AttributeSet attrs) {
        super(context, attrs);
        this.clickListener = null;
    ...
    protected void loadStyle() {
        ...
        if (textStyle.equals("bold")) {
            this.tv_title.setTypeface(Typeface.DEFAULT, Typeface.BOLD);
        } else {
            this.tv_title.setTypeface(Typeface.DEFAULT, Typeface.NORMAL);
        }
    ...
    public void setEnabled(boolean fal) {
        super.setEnabled(fal);
    }
